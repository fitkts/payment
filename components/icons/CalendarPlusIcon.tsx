...
const CalendarPlusIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 12.75h.008v.008H12v-.008Zm0 3h.008v.008H12v-.008Zm0 3h.008v.008H12v-.008Zm-3-3h.008v.008H9v-.008Zm0 3h.008v.008H9v-.008Zm-3-3h.008v.008H6v-.008Zm0 3h.008v.008H6v-.008Zm9-12.75h.008v.008h-.008V3Zm-3 0h.008v.008H12V3Z"
    />
  </svg>
);
